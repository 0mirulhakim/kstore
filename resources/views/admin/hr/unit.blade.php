...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="bg-active">Kod Unit</li>
        </ol>
    </section>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card ">
                        ...
                        <div class="card-header bg-primary text-white">
                            <span class="float-right btn btn-sm btn-warning"><a href="{{ route('hr:createUnit') }}">Daftar Unit</a> </span>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        @foreach($units as $data)
                                            <tr>
                                                ...
                                                <td><a href="">
                                                        <i class=".align-self-center fa-2x far fa-edit" data-toggle="tooltip" data-original-title="Edit Unit"></i>
                                                    </a>
                                                </td>
                                            </tr>
