...
@section('content')
    ...
    <div class="container my-3">
        <h2 id="single_portfolio_title"><label>Sejarah Permohonan Toner</label></h2>
        <div class="row details">
            ...
            <div class="col-md-12 col-lg-6 col-12 wow bounceInRight" data-wow-duration="1.5s">
                <h3 class="project">Lihat Sejarah Permohonan</h3>
                <p class="text-justify">
                <form action="{{ route('detailhistory') }}" role="form" id="form_controls" method="GET">
